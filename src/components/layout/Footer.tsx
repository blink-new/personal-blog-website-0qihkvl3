      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-4">
              A modern blog platform sharing insights on technology, design, and development.
            </p>
          ...
          {/* Blog Links */}
          <div>
            <h3 className="text-sm font-semibold text-primary mb-4">Blog</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-sm text-muted-foreground">
            © {currentYear} Blog. All rights reserved. Built with passion for great content.
          </p>
        </div>
      </div>
    </footer>
